...
public class UPTRCompiler extends Compiler {
	...
	public static IConstructor loadForRascal(IValueFactory vf, IString src, ISourceLocation loc) {
		...
		new UPTRCompiler(vf, errors).loadPT(fileRef, path,
	...
	public static Object loadWithRascal(Reader rdr, String sourcePath,
			String sourceName) {
	...
	public Object loadPT(IConstructor[] fileRef, String sourcePath,
			String sourceName) {
